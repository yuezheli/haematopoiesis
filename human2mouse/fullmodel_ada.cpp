...
Model comparison between ADA model and the original full model (erythrocytes_Hb_lymphoid_myeloid.cpp):
  introducing different death rate for DN, DP, SP cells in thymus. 
