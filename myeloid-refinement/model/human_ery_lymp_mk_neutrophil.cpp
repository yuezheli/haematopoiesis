...
This file refines the myeloid branch on neutrophil development (based on human_ery_lymp_mk_myeloid.cpp)

Model structure & parameters obtained from https://pubmed.ncbi.nlm.nih.gov/28303306/ & https://immunenetwork.org/DOIx.php?id=10.4110/in.2017.17.5.298
...
dxdt_myeloblast = 2 * 1/tauGMP * GMP - 1/tau_myeloblast * myeloblast;

dxdt_promyelocyte = 2 * 1/tau_myeloblast * myeloblast - 1/tau_promyelocyte * promyelocyte; 
