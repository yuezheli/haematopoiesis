...
// fractions of exported cells being sequester in other organ
...
// cell exit rate from secondary lymphoid organs
exit_lymph = 1.2
...
dxdt_cd4rec = (1 - f4) * sum_SP4 - death_cd4b * cd4rec + exit_lymph * cd4lym;
dxdt_cd8rec = (1 - f8) * sum_SP8 - death_cd8b * cd8rec + exit_lymph * cd8lym;

// dynamics of T cells in secondary lymphoid system

dxdt_cd4lym = f4 * sum_SP4 - exit_lymph * cd4lym;
dxdt_cd8lym = f8 * sum_SP8 - exit_lymph * cd8lym; 
